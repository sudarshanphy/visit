...
PyVolumeAttributes_ToString(const VolumeAttributes *atts, const char *prefix, const bool forLogging)
{
    ...
    const char *renderMode_names = "DefaultRenderMode, RayCastRenderMode, GPURenderMode, OSPRayRenderMode, AnariRenderMode";
    switch (atts->GetRenderMode())
    {
      ...
      case VolumeAttributes::AnariRenderMode:
          snprintf(tmpStr, 1000, "%srenderMode = %sAnariRenderMode  # %s\n", prefix, prefix, renderMode_names);
          str += tmpStr;
          break;
      default:
          break;
...
PyVolumeAttributes_getattr(PyObject *self, char *name)
{
    ...
    if(strcmp(name, "AnariRenderMode") == 0)
        return PyInt_FromLong(long(VolumeAttributes::AnariRenderMode));
